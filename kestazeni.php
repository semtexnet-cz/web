...
"><nav class="navbar"><!-- Brand and toggle get grouped for better mobile display --><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><i class="glyphicon glyphicon-menu-hamburger"></i> MENU
                ...
                <a href="index.php"  >Internet</a></li><li ><a href="televize.php"  >Televize</a></li><li class="active"><a href="kestazeni.php"  >Ke stažení</a></li><li ><a href="kontakt.php"  >Kontakt</a></li><!--<li class="menuicon1 invert"><a href="#" ><img class="iconGray" src="/static/images/cart.png"><img class="iconwhite" src="/static/images/cart-white.png"></a></li><li class="menuicon2 invert"><a href="#">
...
<div class="container main white">
                <div class="container mainIn"><div class="sectionLeft "><div class="headText left col-lg-11 col-md-11 minwidth623 paddtop100 cor-c1t"><p class="lastText">
                <a href="kestazeni/Smlouva SemtexNET.pdf"><font color="fbab2d"><b>Smlouva</font></b></a> o poskytování datových služeb<br><br>
                <a href="https://www.google.com/chrome/browser/desktop/index.html#"><font color="fbab2d"><b>Google Chrome</font></b></a> oblíbený internetový prohlížeč<br><br>
                <a href="https://chrome.google.com/webstore/detail/adblock-plus/cfhdojbkjhnklbpkdaibdccddilifddb?hl=cs<br>"><font color="fbab2d"><b>Adblock Plus</font></b></a> rozšíření proti vyskakujícím reklamám v Google Chrome<br><br>
                <a href="https://download.teamviewer.com/download/TeamViewer_Setup_cs.exe"><font color="fbab2d"><b>TeamViewer</font></b></a> program pro vzdálené ovládání vašeho PC naším technikem<br><br>
                </p>
...
</div></div></div></div><div class="sectionLeftImg col-lg-5 col-md-5"><img src="images/antena.jpg" class="leftSectionImg cor-c1i"></div>

<a href="kestazeni/Všeobecné podmínky SemtexNET.pdf" title="Všeobecné podmínky"><font color="000">Všeobecné podmínky</font></a> |
<a href="kestazeni/Informace pro zákazníky SemtexNET.pdf" title="Informace pro zákazníky"><font color="000">Informace pro zákazníky</font></a> | 
<a href="kestazeni/Podmínky zpracování osobních údajů SemtexNET.pdf" title="Podmínky zpracování osobních údajů"><font color="000">Zpracování osobních údajů</font></a> | 
<a href="kestazeni/Ceník SemtexNET.pdf" title="Ceník"><font color="000">Ceník</font></a><br> 
<a href="kestazeni/Specifikace použitých rozhraní v telekomunikační síti SemtexNET.pdf" title="Specifikace použitých rozhraní v telekomunikační síti"><font color="000">Specifikace použitých rozhraní v telekomunikační síti</font></a> |
<a href="kestazeni/Výpověď smlouvy SemtexNET.pdf" title="Výpověď smlouvy"><font color="000">Výpověď</font></a> | 
<a href="kestazeni/EU 2015-2120.pdf" title="EU 2015/2120"><font color="000">EU 2015/2120</font></a>

</div></div></div><div class="container main"><div class="container main gray graysec"><div class="container mainIn"><div class="sectionHead paddBot50" id="dam-na-kvalitu">
