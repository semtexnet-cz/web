...
</script><div id="fuckeu"><p>Soubory cookie nám pomáhají poskytovat, chránit a zlepšovat naše služby. Pokud budete náš web používat i nadále, vyjádříte tím svůj souhlas s našimi zásadami týkajícími se souborů cookie.</p><a class="btn-eu" href="#" id="fuckeu-ok"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;Souhlasím</a>&nbsp;&nbsp;&nbsp;
<a class="btn-info-eu" href="cookies-vice-informaci.html"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>&nbsp;Další informace</a></div>
...
<!--navigacni menu end--><div class="container main white">
                <div class="container mainIn"><div class="sectionLeft "><div class="headText left col-lg-11 col-md-11 minwidth623 paddtop100 cor-c1t"><span id="pb-section_cinema_1" class="anchor"></span><p class="preText">Vysokorychlostní bezdrátový</p><h2>Internet</h2><p class="lastText">Naším hlavním cílem je pomocí nejnovějších technologií maximální spokojenost i těm nejnáročnějším uživatelům. Internet, který nabízíme je rychlý, spolehlivý s neomezeným objemem přenesených dat a přístupný 24 hodin denně.
                <br>
                
                </p>
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false"><div class="panel">

<div id="section1" class="panel-collapse collapse nopadd" role="tabpanel" aria-labelledby="heading1"><div class="panel-body left nopadd"><span id="pb-section_cinema_1_more" class="anchor"></span><p><br/>
<p align="left">Štarnov<br/>Šternberk<br/></p></p></div></div>

<div id="section3" class="panel-collapse collapse nopadd" role="tabpanel" aria-labelledby="heading1"><div class="panel-body left nopadd"><span id="pb-section_cinema_1_more" class="anchor"></span><p><br/>
<table class="tg" align="left" style="undefined;table-layout: fixed">
<colgroup>
...
<col style="width: 95px">
  ...
  <tr>
    <th class="tg-hgcj"><p align="left">Název tarifu&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <th class="tg-hgcj"><p align="left">Rychlost stahování&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <th class="tg-hgcj"><p align="left">Rychlost nahrávání&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
    <th class="tg-34fq"><p align="left">Cena&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
  </tr>
  <tr>
    <td class="tg-s6z2"><p align="left">&nbsp;20M</td>
    <td class="tg-s6z2s"><p align="left">&nbsp;20Mbps</td>
    <td class="tg-s6z2s"><p align="left">20Mbps</td>
    <td class="tg-0ords"><p align="left">220Kč/měsíc</td>
  </tr>
  <tr>
    <td class="tg-s6z2"><p align="left">&nbsp;25M</td>
    <td class="tg-s6z2"><p align="left">&nbsp;25Mbps</td>
    <td class="tg-s6z2"><p align="left">25Mbps</td>
    <td class="tg-0ord"><p align="left">400Kč/měsíc</td>
  </tr>
  <tr>
    <td class="tg-s6z2"><p align="left">&nbsp;30M</td>
    <td class="tg-s6z2s"><p align="left">&nbsp;30Mbps</td>
    <td class="tg-s6z2s"><p align="left">30Mbps&nbsp;</td>
    <td class="tg-0ords"><p align="left">500Kč/měsíc</td>
  </tr>
</table>
<p><br><br><br><br><br><br><br><p align="left">
Jsme schopni vytvořit i individuální tarif.
<br><br><br>
<strong>Ceny součástí a služeb</strong>
<br>
 Přijímací anténa (dle podmínek): 1160Kč až 2700Kč
<br>
 Dvouanténový Wi-fi router 2,4GHz: 500Kč
 <br>
 Čtyřanténový gigabitový Wi-fi router 2,4/5GHz: 1000Kč
<br>
 UTP stíněný kabel: 12Kč/m
<br>
 Změření síly signálu: ZDARMA
<br>
 Návrh sítě: ZDARMA
<br>
 Práce na nové přípojce: ZDARMA
<br>
 Změna tarifu: ZDARMA
<br>
<a href="kestazeni/Ceník SemtexNET.pdf" title="Ceník"><font color="000">Kompletní ceník</font></a> 
<br><br>
</p></p>
</p></div></div>

<div class="panel-heading left" role="tab" id="heading1">
<a class="collapsed orange-text morehref morelesstoggle" role="button" data-toggle="collapse" data-parent="#accordion" href="#section1" aria-expanded="false" aria-controls="section2" data-moreless-more="Pokrytí&nbsp;" data-moreless-less="Pokrytí&nbsp;" data-ga-event="js" data-ga-event-label="">Pokrytí&nbsp;</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="collapsed orange-text morehref morelesstoggle" role="button" data-toggle="collapse" data-parent="#accordion" href="#section3" aria-expanded="false" aria-controls="section2" data-moreless-more="Ceník&nbsp;" data-moreless-less="Ceník&nbsp;" data-ga-event="js" data-ga-event-label="">Ceník&nbsp;</a>

</div></div></div></div><div class="sectionLeftImg col-lg-5 col-md-5"><img src="images/antena.jpg" class="leftSectionImg cor-c1i"></div></div></div></div>
<font color="ffffff">Internet Šternberk, Babice, Hlásnice, Krákořice, Mladějovice, Stádlo, Štarnov, Internet Šternberk, Internet Babice, Internet Hlásnice, Internet Krákořice, Internet Mladějovice, Internet Stádlo, 
Internet Štarnov, SemtexNET, Připojení, Bezdrátový, Internet</font>


<div class="container main"><div class="container main gray graysec"><div class="container mainIn"><div class="sectionHead paddBot50" id="dam-na-kvalitu">
