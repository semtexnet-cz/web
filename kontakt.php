...
"><nav class="navbar"><!-- Brand and toggle get grouped for better mobile display --><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><i class="glyphicon glyphicon-menu-hamburger"></i> MENU
                ...
                <a href="index.php"  >Internet</a></li><li ><a href="televize.php"  >Televize</a></li><li ><a href="kestazeni.php"  >Ke stažení</a></li><li class="active"><a href="kontakt.php"  >Kontakt</a></li><!--<li class="menuicon1 invert"><a href="#" ><img class="iconGray" src="/static/images/cart.png"><img class="iconwhite" src="/static/images/cart-white.png"></a></li><li class="menuicon2 invert"><a href="#">
...
<div class="container main transition"><div class="container mainIn"><div class="sectionHeadC"><div class="headText center"><span id="pb-section_contact_0_fix" class="anchor"></span><h1 style="text-align: center;"><span style="color:#D3D3D3;">+420 </span><span style="color:#696969;">736 107 515</span></h1><p style="text-align: center;"><span style="color:#696969;"><span style="font-size: 26px;"><a href="mailto:semtexnet@semtexnet.cz"><font color="696969">semtexnet@semtexnet.cz</font></a><br><a href="mailto:info@semtexnet.cz"><font color="696969">info@semtexnet.cz</font></a><br><br></span></span></p><p style="text-align: center;"></p></div></div></div></div><div class="container main white"><div class="container mainIn"><div class="sectionHead paddBotZero"><div class="headText center paddBot100 contactAdr"><span id="pb-section_contact_1" class="anchor"></span>
