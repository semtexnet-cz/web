...
"><nav class="navbar"><!-- Brand and toggle get grouped for better mobile display --><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><i class="glyphicon glyphicon-menu-hamburger"></i> MENU
                ...
                <li ><a href="index.php"  >Internet</a></li><li class="active"><a href="televize.php"  >Televize</a></li><li ><a href="kestazeni.php"  >Ke stažení</a></li><li ><a href="kontakt.php"  >Kontakt</a></li><!--<li class="menuicon1 invert"><a href="#" ><img class="iconGray" src="/static/images/cart.png"><img class="iconwhite" src="/static/images/cart-white.png"></a></li><li class="menuicon2 invert"><a href="#">
...
<!--navigacni menu end--><div class="container main white">
                <div class="container mainIn"><div class="sectionLeft "><div class="headText left col-lg-11 col-md-11 minwidth623 paddtop100 cor-c1t"><span id="pb-section_cinema_1" class="anchor"></span><p class="preText">Kvalitní HD</p><h2>Televize</h2><p class="lastText">Zprostředkujeme vám DVB-T2 nebo DVB-S2 televizní vysílání. V nabídce je 130 českých a slovenských programů, z toho 60 v HD kvalitě a asi dalších 80 zahraničních. Instalujeme osvědčené přijímače, na které vydáváme pravidelné aktualizace. Takže vás už nečeká žádné ladění a uspořádávání stanic.</p>
...
<p align="left">Celá ČR</p></p></div></div>
...
<div id="section4" class="panel-collapse collapse nopadd" role="tabpanel" aria-labelledby="heading1"><div class="panel-body left nopadd"><span id="pb-section_cinema_1_more" class="anchor"></span><p><br/>

<center align="center">
<h2>Aktuální nabídka programů</h2>
<h3><br>České a slovenské</h3> (Aktualizováno 5.2.2019)
</center>
...
<br><br><br>
<center align="left"><img src="tvkanaly/desitky.png">





<p class="lastText"><img src="tvkanaly/hd.png"> - Program ve vysokém rozlišení</p>
<br><br><br>
</div></div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="collapsed orange-text morehref morelesstoggle" role="button" data-toggle="collapse" data-parent="#accordion" href="#section4" aria-expanded="false" aria-controls="section2" data-moreless-more="Programy&nbsp;" data-moreless-less="Programy&nbsp;" data-ga-event="js" data-ga-event-label="">Programy&nbsp;</a>

</div></div></div></div><div class="sectionLeftImg col-lg-5 col-md-5"><img src="images/tv.jpg" class="leftSectionImg cor-c1i"></div></div></div></div><div class="container main"><div class="container main gray graysec"><div class="container mainIn"><div class="sectionHead paddBot50" id="dam-na-kvalitu">
